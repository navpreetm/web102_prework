...
const displayStr = `A total of $${totalPledged} has been raised for ${GAMES_JSON.length} games. Currently, ${Unfunded.length != 1 ? `${Unfunded.length} games remain unfunded. We need your help to fund these amazing games!` : `${Unfunded.length} game remain unfunded. We need your help to fund these amazing games!`}`;
